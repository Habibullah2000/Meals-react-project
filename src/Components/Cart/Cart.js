...
const Cart = (props) => {
  ...
  const submitOrderHandler = async (userData) => {
    ...
    await fetch(
      "https://meals-backend-app-default-rtdb.firebaseio.com/orders.json",
      {
        method: "POST",
  ...
  return (
    <Modal onClose={props.onClose}>
      {!isSubmittig && !didSubmit && cartModalContent}
      {isSubmittig && isSubmittigModalContent}
      {!isSubmittig && didSubmit && didSubmitModalContent}
    </Modal>
  );
};
